...
def main():
    ...
    for repeat in range(args.repeats):
        ...
        if args.loss_type == 'full':
            ...
            # cov_fac_params = [p for name, p in model.named_parameters() if 'cov' in name]
            # others = [p for name, p in model.named_parameters() if 'cov' not in name]
        ...
        # scheduler_L = torch.optim.lr_scheduler.StepLR(optimizer, step_size=30)
